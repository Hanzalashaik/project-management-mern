...
export default function EditTable({ onupdate, onsubmit }) {
    ...
    async function handleSave(e) {
        ...
        try {
            ...
            const response = await axios.post("http://192.168.0.99:5000/user//updatebyid/1/3/projects", updatedProjects);
